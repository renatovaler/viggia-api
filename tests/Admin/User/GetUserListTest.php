...
class GetUserListTest extends TestCase
{
    ...
    public function _test_get_user_list_with_not_authenticated_user()
    {
        // Cria usuários
		$this->createUsers(15);
    ...
    public function _test_get_user_list_with_common_user()
    {
    ...
    public function _test_get_user_list_with_admin_user()
    {
