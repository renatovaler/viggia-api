...
class GetUserProfileInformationTest extends TestCase
{
    ...
    public function _test_get_user_profile_with_not_authenticated_user()
    {
        // Cria o usuário
    ...
    public function _test_get_user_profile_with_common_user()
    {
    ...
    public function _test_get_user_profile_with_admin_user()
    {
